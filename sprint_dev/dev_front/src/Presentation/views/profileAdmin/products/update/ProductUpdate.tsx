  ...
  return (
    <View style= {styles.container}>
        ...
        <View style= {styles.form}>
            <Text /* style = {styles.formText} */> {product.Tipo_Producto_idTipo_Producto}Modificar datos del producto {product.nombre} de la categoria {category.nombre_tipo}</Text>
            <CustomTextInput 
